    ...
    return (
        <div className="bg-[#f5f7f8] font-sans text-[#0f172a] antialiased min-h-screen">
            ...
            <header className="bg-white sticky top-0 z-50 border-b border-slate-100">
                <div className="flex justify-between items-center w-full px-6 md:px-8 py-4 max-w-[1400px] mx-auto gap-4">
                    <Link href="/" className="text-2xl font-bold tracking-tighter text-[#006837] whitespace-nowrap">
                        UTAD FastTicket
                    </Link>
